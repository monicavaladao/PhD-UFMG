...
% =========================================================================
% Adaptation of the oodacefit in order to set other parameter for
% hyperparameter optimizer.
% 2020-29-04
% Monica A. C. Valadao
%
function k = oodacefit_saea( samples, values, userOpts )
...
% Default parameters if fmincon optimizer is used
opts.DerivativeCheck = [];
opts.Diagnostics = [];
opts.Algorithm = [];
opts.MaxFunEvals = [];
opts.MaxIter = [];
...
% Default parameters if ga optimizer is used
opts.Display = [];
opts.Generations = [];
opts.EliteCount = [];
opts.CrossoverFraction = [];
opts.PopInitRange = [];
opts.PopulationSize = [];
opts.MigrationInterval = [];
opts.MigrationFraction = [];
opts.Vectorize = [];
opts.HybridFcn = [];
opts.MutationFcn = [];
