...
dir_output = './to_complete_results_30/analytic';
...
nthreads = 1;%4;%8;                % num. of threads to use
...
fid = fopen(strcat(dir_output, '/results_30.csv'), 'w+');
