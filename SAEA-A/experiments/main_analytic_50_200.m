...
dir_output = './results_50_200/analytic';
...
% -------------------------------------------------------------------------
% Problems to solve
nvars = [50, 100, 150, 200];
npop = [50 + floor(nvars(1)/10), 50 + floor(nvars(2)/10), 80 + floor(nvars(3)/10), 80 + floor(nvars(4)/10)];
        
neval = [2000, 2000, 2000, 2000];
...
fid = fopen(strcat(dir_output, '/results_50_200.csv'), 'w+');
