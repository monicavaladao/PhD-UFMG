function [model_info] = build_metamodel_DIRECT(sample_X, sample_y, lb, ub, type, params)
...
switch type
    case 'SimpleKriging_ooDACE'
        model_info = simple_kriging_oodace(sample_X, sample_y, lb, ub, oodace_opts);
...
% Auxiliary functions
% =========================================================================
% Simple Kriging Metamodel using ooDACE Toolbox (The Standard OK)
function model_info = simple_kriging_oodace(sample_X, sample_y, lb, ub, oodace_opts)
    
% Set some settings
oodace_opts.type = 'Kriging';          
oodace_opts.regrFunc = ''; % No regression function is used
...
ModelooDACE = oodacefit_saea(sample_X, sample_y, oodace_opts);
...
switch type_rbf
    ...
    case 'ThinPlateSpline'
        % RBF Metamodel with Inverse Multiquadric function
        srgtstoolbox_opts.P = sample_X;
        srgtstoolbox_opts.T = sample_y;
