...
parser.addParameter('Metamodel', 'OrdinaryKriging_SRGTSToolbox', @ischar);
%parser.addParameter('Metamodel', 'UniversalKriging1_SRGTSToolbox', @ischar);
...
params.max_pool_size = max(400,init_sample_size);%400;%2*params.sample_size;%400;%2*params.sample_size;
