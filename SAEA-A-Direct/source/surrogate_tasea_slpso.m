function [best_x, best_y, info] = surrogate_tasea_slpso(fobj, X, y, lb, ub, max_eval, varargin)
...
while eval_counter < params.max_eval
    ...
    [P,P_V,P_CR,Nf,DE_counter, any_DE_used] = create_offsprings_tasea_slpso(pop_X, pop_y, pop_V, pop_CR, best_x, lb, ub, ...
...
%    [CR, CRm, S_A] = crossover_rate_self_adaptation(params.CR, params.CRm, params.S_A, N, n, DE_counter);
    ...
    % Update info.params
    info.params.FM.Nf = params.FM.Nf;
    info.params.FM.Ngood = params.FM.Ngood;
    info.params.CR = params.CR;
    info.params.CRm = params.CRm;
    info.params.S_A.CRrec = params.S_A.CRrec;
    info.params.S_A.Pimp = params.S_A.Pimp;
    info.params.S_A.fbest_initial = params.S_A.fbest_initial;
