function [] = launch_noDE(problem, metamodel, rule, seed, dir_output, strategy, filename)
...
% Solve the problem
[best_x, best_y, info] = surrogate_tasea_slpso_noDE(fobj, X, y, lb, ub, neval, metamodel.params{:}, rule.choose_sample{:});
