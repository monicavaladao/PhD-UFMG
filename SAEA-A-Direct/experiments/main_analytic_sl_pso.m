...
addpath(genpath('./SL_PSO'));


% -------------------------------------------------------------------------
% Output directory in which results will be saved

dir_output = './results/analytic_SL_PSO';
...
for i = 1:length(entries)
    f(i) = parfeval(p, @launch_sl_pso, 0, entries(i).problem, alg, ...
...
fid = fopen(strcat(dir_output, '/results_sl_pso.csv'), 'w+');
