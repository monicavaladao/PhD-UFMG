...
metamodel.factors <- list(OK  = "tasea-ordinary-kriging",
...
fig <- ggplot2::ggplot(aggdata,
  ...
  ggforce::facet_zoom(x = METAMODEL %in% c("RBF", "OK"), zoom.size = 1, show.area = TRUE, shrink = TRUE)

filename = "./figures/crossbar/crossbar.pdf"
ggplot2::ggsave(filename, plot=fig, width=10, height=7)
...
filename = "./figures/ci/ci-improv.pdf"
ggplot2::ggsave(filename, plot=fig, width=10, height=7)
...
filename = "./figures/ci/ci-time.pdf"
ggplot2::ggsave(filename, plot=fig, width=10, height=7)
...
levels(aggdata$METAMODEL) <- list(OK  = "tasea-ordinary-kriging",
                                  #UK1 = "universal-kriging1", 
                                  #UK2 = "universal-kriging2",
                                  #BK  = "blind-kriging",
                                  RBF = "tasea-rbf-gaussian",
...
xtable(table.results, digits = c(6,0,4,4))
