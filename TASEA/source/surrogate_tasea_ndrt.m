function [best_x, best_y, info] = surrogate_tasea_ndrt(fobj, X, y, lb, ub, max_eval, varargin)
...
while eval_counter < params.max_eval
    ...
    [x_b, y_b, pred_b] = prescreening_solution_ndrt(fobj, P, best_x, lb, ub, rule_choose_sample, sample_size, params, info.pool, info);
