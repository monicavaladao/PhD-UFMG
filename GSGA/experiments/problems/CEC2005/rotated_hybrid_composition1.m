% F16: Rotated Version of Hybrid Composition Function
% Properties:
%   Non-separable
%   Multimodal
%   Rotated
...
%   Global optimum: x = o(1,1:D), F16(x) = f_bias16 = 120
function [y] = rotated_hybrid_composition1(x)
global initial_flag
initial_flag = 0;

func_num = 16;
fhd=str2func('hybrid_rot_func1'); 
...
if initial_flag==0
    ...
    if length(o(1,:))>=D
         o=o(:,1:D);
         file_name = strcat('hybrid_func1_M','_D', int2str(D),'.mat');
         load(file_name);
    else
